...
walley_sample = "dataset/hey_titi/negative/0_0.wav"
# walley_sample = "dataset/hey_titi/positive/0_0.wav"
...
data_path_dict = {
    0: ["dataset/hey_titi/negative/" + file_path for file_path in os.listdir("dataset/hey_titi/negative/")],
    1: ["dataset/hey_titi/positive/" + file_path for file_path in os.listdir("dataset/hey_titi/positive/")]
}
...
df.to_pickle("dataset/final_hey_titi_audio_data.pickle")